...
describe('asyncapi channel test', function () {
  ...
  it('validate channel address parameters are correct (AsyncAPI 3)', async function () {
    const validationContext: ValidationContext = {
      comments: DiagnosticSeverity.Error,
      maxNumberOfProblems: 100,
      relatedInformation: false,
    ...
    const doc: TextDocument = TextDocument.create(
      'foo://bar/channel-address-parameters-valid.yaml',
      'yaml',
      0,
      specChannelAddressParametersValid,
    );
  ...
  it('validate parameters required when address has expressions (AsyncAPI 3)', async function () {
    ...
    const doc: TextDocument = TextDocument.create(
      'foo://bar/channel-address-parameters-missing.yaml',
      'yaml',
      0,
      specChannelAddressParametersMissing,
    );
  ...
  it('validate parameter key exists in address (AsyncAPI 3)', async function () {
    ...
    const doc: TextDocument = TextDocument.create(
      'foo://bar/channel-address-parameter-mismatch.yaml',
      'yaml',
      0,
      specChannelAddressParameterMismatch,
    );
  ...
  it('validate address expressions are defined in parameters (AsyncAPI 3)', async function () {
    ...
    const doc: TextDocument = TextDocument.create(
      'foo://bar/channel-address-expression-not-defined.yaml',
      'yaml',
      0,
      specChannelAddressExpressionNotDefined,
    );
