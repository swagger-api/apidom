...
const documentation = [
  ...
  {
    target: 'prefix',
    docs: 'The prefix to be used for the [name](https://github.com/OAI/OpenAPI-Specification/blob/main/versions/3.1.2.md#fixed-fields-23).',
