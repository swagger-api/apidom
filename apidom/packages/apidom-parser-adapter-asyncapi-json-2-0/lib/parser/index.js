...
var _apidomNsAsyncapi = _interopRequireDefault(require("apidom-ns-asyncapi-2-0"));
...
var namespace = (0, _apidom.createNamespace)(_apidomNsAsyncapi["default"]);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            (0, _apidomParserAdapterJson.visit)(ast.rootNode, documentVisitor, {
              keyMap: keyMap,
              // @ts-ignore
              state: {
                namespace: namespace,
