...
[Detection](https://github.com/swagger-api/apidom/blob/main/packages/apidom-parser-adapter-openapi-yaml-3-0/src/adapter.ts#L21) is based on a regular expression matching required OpenAPI 3.0.x specification symbols in YAML format.
