...
import {
  ...
  detect,
} from '@swagger-api/apidom-parser-adapter-openapi-json-3-2';
...
export interface OpenAPIJSON3_2ParserOptions extends Omit<ParserOptions, 'name'> {}
...
class OpenAPIJSON3_2Parser extends Parser {
  ...
  constructor(options?: OpenAPIJSON3_2ParserOptions) {
    const { fileExtensions = [], mediaTypes = OpenAPI3_2MediaTypes, ...rest } = options ?? {};

    super({ ...rest, name: 'openapi-json-3-2', fileExtensions, mediaTypes });
  }
