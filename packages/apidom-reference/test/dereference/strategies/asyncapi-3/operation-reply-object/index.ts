...
describe('dereference', function () {
  context('strategies', function () {
    context('asyncapi-3', function () {
      context('Operation Reply Object', function () {
        ...
        context('given in components/replies field', function () {
          const fixturePath = path.join(rootFixturePath, 'components-replies');
