...
const serverComplete: ApidomCompletionItem[] = [
  {
    label: 'url',
    insertText: 'url',
    kind: 14,
  ...
  },
  {
    ...
    documentation: {
      kind: 'markdown',
      value:
        '**REQUIRED**. The protocol this URL supports for connection. Supported protocol include, but are not limited to: `amqp`, `amqps`, `http`, `https`, `ibmmq`, `jms`, `kafka`, `kafka-secure`, `anypointmq`, `mqtt`, `secure-mqtt`, `stomp`, `stomps`, `ws`, `wss`, `mercure`.',
    },
  },
  {
  ...
  },
  {
    ...
    documentation: {
      kind: 'markdown',
      value:
        "Map[`string`, [Server Variable Object](https://www.asyncapi.com/docs/specifications/v2.2.0#serverVariableObject)]\n\n ---- \n\nA map between a variable name and its value. The value is used for substitution in the server's URL template.",
    },
  },
  {
    label: 'security',
