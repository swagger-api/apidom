...
import OpenAPI3_2DereferenceVisitor from './visitor.ts';
...
export type { OpenAPI3_2DereferenceVisitorOptions, mutationReplacer } from './visitor.ts';
export type {
 ...
 * @public
 */
export interface OpenAPI3_2DereferenceStrategyOptions
  extends Omit<DereferenceStrategyOptions, 'name'> {}

/**
 * @public
 */
class OpenAPI3_2DereferenceStrategy extends DereferenceStrategy {
  constructor(options?: OpenAPI3_2DereferenceStrategyOptions) {
  ...
  async dereference(file: File, options: ReferenceOptions): Promise<Element> {
    ...
    const visitor = new OpenAPI3_2DereferenceVisitor({ reference: reference!, namespace, options });
...
export { OpenAPI3_2DereferenceVisitor };
export {
...
export default OpenAPI3_2DereferenceStrategy;
