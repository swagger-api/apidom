...
const SpecificationVisitor = require('../visitors/SpecificationVisitor');

const ArrayVisitor = stampit(SpecificationVisitor).init(function ArrayVisitor() {
  const stack = [];
...
const ObjectVisitor = stampit(SpecificationVisitor).init(function ObjectVisitor() {
  const stack =  [];
...
const ValueVisitor = stampit(SpecificationVisitor, {
  methods: {
    array(arrayNode) {
      const arrayVisitor = this.retrieveVisitorInstance(['array']);
