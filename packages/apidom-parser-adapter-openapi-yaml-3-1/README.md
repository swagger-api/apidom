...
`@swagger-api/apidom-parser-adapter-openapi-yaml-3-1` is a parser adapter for the [OpenApi 3.1.0 specification](https://github.com/OAI/OpenAPI-Specification/blob/master/versions/3.1.0.md) in [YAML format](https://yaml.org/spec/1.2/spec.html).
Under the hood this adapter uses [apidom-parser-adapter-yaml-1-2](https://github.com/swagger-api/apidom/tree/master/packages/apidom-parser-adapter-yaml-1-2)
...
[Detection](https://github.com/swagger-api/apidom/blob/master/packages/apidom-parser-adapter-openapi-yaml-3-1/src/adapter.ts#L13) is based on a regular expression matching required OpenApi 3.1.0 specification symbols in YAML format.
...
--- | --- | --- | ---
<a name="specObj"></a>`specObj` | `Object` | [Specification Object](https://github.com/swagger-api/apidom/blob/master/packages/apidom-parser-adapter-yaml-1-2/src/parser/specification.ts) | This specification object drives the YAML AST transformation to base ApiDOM namespace.
