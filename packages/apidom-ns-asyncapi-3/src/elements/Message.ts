...
import { ExternalDocumentationElement, MessageElement } from '@swagger-api/apidom-ns-asyncapi-2';
...
class Message extends MessageElement {
  ...
  set headers(
    headers: MultiformatSchemaElement | SchemaElement | ReferenceElement | undefined | any,
  ) {
  ...
  set payload(
    payload: MultiformatSchemaElement | SchemaElement | ReferenceElement | undefined | any,
  ) {
