    ...
    return {
      visitor: {
        ...
        PathItemElement(
          ...
          if (!ancestors.some(predicates.isOpenApi3_2Element)) return;
          ...
          const parentOpenapiElement = ancestors.find(predicates.isOpenApi3_2Element);
          ...
          if (predicates.isOpenApi3_2Element(parentOpenapiElement)) {
