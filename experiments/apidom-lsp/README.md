...
/dati/dev/progetti/swagger/projects/apidom/git-lsp-new/apidom/apidom/node_modules/tree-sitter-json/build/Release/tree_sitter_json_binding.node
...
```
cd /dati/dev/progetti/swagger/projects/apidom/git-lsp-new/apidom/apidom/node_modules/tree-sitter
node-gyp rebuild --target=9.3.3 --arch=x64 --dist-url=https://electronjs.org/headers
cd /dati/dev/progetti/swagger/projects/apidom/git-lsp-new/apidom/apidom/node_modules/tree-sitter-json
node-gyp rebuild --target=9.3.3 --arch=x64 --dist-url=https://electronjs.org/headers
cd /dati/dev/progetti/swagger/projects/apidom/git-lsp-new/apidom/apidom/node_modules/tree-sitter-yaml
node-gyp rebuild --target=9.3.3 --arch=x64 --dist-url=https://electronjs.org/headers
cd ROOT
npm install
cd apidomlsp
...
```
ALl packages
npm install --save-dev electron@9.3.3
