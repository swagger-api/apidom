const serverBindingsDocs = [
  ...
  {
    target: 'mqtt',
    docs: '[MQTT Server Binding](https://github.com/asyncapi/bindings/blob/master/mqtt#server)\n\\\n\\\nProtocol-specific information for an MQTT server.',
  },
  {
    target: 'mqtt5',
  ...
  {
    target: 'solace',
    docs: '[Solace Server Binding](https://github.com/asyncapi/bindings/tree/master/solace#server-binding-object)\n\\\n\\\nProtocol-specific information for a Solace server.',
  },
  {
    target: 'sqs',
  ...
  {
    target: 'ibmmq',
    docs: '[IBM MQ Server Binding](https://github.com/asyncapi/bindings/blob/master/ibmmq#server-binding-object)\n\\\n\\\nProtocol-specific information for an IBM MQ server.',
  },
  {
    docs: 'Map describing protocol-specific definitions for a server.',
  },
];
export default serverBindingsDocs;
