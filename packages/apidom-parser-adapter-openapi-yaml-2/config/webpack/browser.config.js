...
const browser = {
  ...
  output: {
    ...
    filename: 'apidom-parser-adapter-openapi-yaml-2.browser.js',
    libraryTarget: 'umd',
    library: 'apidomParserAdapterOpenApiYaml2',
  },
  resolve: {
...
const browserMin = {
  ...
  output: {
    path: path.resolve('./dist'),
    filename: 'apidom-parser-adapter-openapi-yaml-2.browser.min.js',
    libraryTarget: 'umd',
    library: 'apidomParserAdapterOpenApiYaml2',
  },
  resolve: {
