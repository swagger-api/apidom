    ...
    document: {
      objects: {
        WorkflowsSpecification: {
          $visitor: typeof WorkflowsSpecificationVisitor;
          fixedFields: {
            workflowSpec: typeof WorkflowsSpecVisitor;
            info: {
              $ref: '#/visitors/document/objects/Info';
            };
            sourceDescriptions: typeof SourceDescriptionsVisitor;
            workflows: typeof WorkflowsVisitor;
            components: {
        ...
        SourceDescription: {
          $visitor: typeof SourceDescriptionVisitor;
          fixedFields: {
            name: { $ref: '#/visitors/value' };
            url: typeof SourceDescriptionUrlVisitor;
            type: { $ref: '#/visitors/value' };
          };
        };
        Workflow: {
          $visitor: typeof WorkflowVisitor;
          fixedFields: {
            workflowId: { $ref: '#/visitors/value' };
            summary: { $ref: '#/visitors/value' };
            description: { $ref: '#/visitors/value' };
            inputs: typeof JSONSchemaVisitor;
            steps: typeof WorkflowStepsVisitor;
            outputs: typeof workflowOutputsVisitor;
          };
        };
        Step: {
          $visitor: typeof StepVisitor;
          fixedFields: {
            description: { $ref: '#/visitors/value' };
            ...
            workflowId: { $ref: '#/visitors/value' };
            parameters: typeof StepParametersVisitor;
            dependsOn: typeof StepDependsOnVisitor;
            successCriteria: typeof StepSuccessCriteriaVisitor;
            onSuccess: typeof StepOnSuccessVisitor;
            onFailure: typeof StepOnFailureVisitor;
            outputs: typeof StepOutputsVisitor;
          };
        };
        Parameter: {
        ...
        SuccessAction: {
          $visitor: typeof SuccessActionVisitor;
          fixedFields: {
            type: { $ref: '#/visitors/value' };
            workflowId: { $ref: '#/visitors/value' };
            stepId: { $ref: '#/visitors/value' };
            criteria: typeof SuccessActionCriteriaVisitor;
          };
        };
        FailureAction: {
          $visitor: typeof FailureActionVisitor;
          fixedFields: {
            type: { $ref: '#/visitors/value' };
            workflowId: { $ref: '#/visitors/value' };
            stepId: { $ref: '#/visitors/value' };
            ...
            criteria: typeof FailureActionCriteriaVisitor;
          };
        };
        Components: {
          $visitor: typeof ComponentsVisitor;
          fixedFields: {
            inputs: typeof ComponentsInputsVisitor;
            parameters: typeof ComponentsParametersVisitor;
          };
        };
        Criterion: {
          $visitor: typeof CriterionVisitor;
          fixedFields: {
        ...
        Schema: {
          ...
          fixedFields: typeof jsonSchemaFixedFields;
        };
        JSONSchema: {
          $visitor: typeof JSONSchemaVisitor;
          fixedFields: typeof jsonSchemaFixedFields;
