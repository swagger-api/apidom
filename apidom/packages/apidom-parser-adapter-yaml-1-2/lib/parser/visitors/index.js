...
var keyMapDefault = (_keyMapDefault = {}, _defineProperty(_keyMapDefault, _apidomAst.YamlStream.type, ['content']), _defineProperty(_keyMapDefault, _apidomAst.YamlDocument.type, ['children']), _defineProperty(_keyMapDefault, _apidomAst.YamlMapping.type, ['content']), _defineProperty(_keyMapDefault, _apidomAst.YamlSequence.type, ['content']), _defineProperty(_keyMapDefault, _apidomAst.YamlKeyValuePair.type, ['key', 'value']), _defineProperty(_keyMapDefault, _apidomAst.Error.type, ['children']), _keyMapDefault);
