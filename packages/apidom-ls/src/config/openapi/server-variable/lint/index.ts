...
import enumType3_1__3_2Lint from './enum--type-3-1--3-2.ts';
import defaultTypeLint from './default--type.ts';
import defaultInEnum3_0Lint from './default--in-enum-3-0.ts';
import defaultInEnum3_1__3_2Lint from './default--in-enum-3-1--3-2.ts';
...
const lints = [
  enumType3_0Lint,
  enumNonEmpty3_0Lint,
  enumType3_1__3_2Lint,
  defaultInEnum3_0Lint,
  defaultInEnum3_1__3_2Lint,
  defaultTypeLint,
  defaultRequiredLint,
  descriptionTypeLint,
  allowedFieldsLint,
