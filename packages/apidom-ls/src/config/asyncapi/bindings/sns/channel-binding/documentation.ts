...
const documentation = [
  ...
  {
    docs: '#### [Channel Binding Object](https://github.com/asyncapi/bindings/blob/master/sns/2.x.x/README.md#channel)\n\nThis object contains the information to configure the associated SNS Topic.\n\nField Name | Type | Description\n---|:---:|---\n`name` | string | **Required.** The name of the topic. Can be different from the channel name to allow flexibility around AWS resource naming limitations.\n`ordering` | [ordering](https://github.com/asyncapi/bindings/blob/master/sns/2.x.x/README.md#ordering) | **Optional.** By default, we assume an unordered SNS topic. This field allows configuration of a FIFO SNS Topic.\n`policy` | [policy](https://github.com/asyncapi/bindings/blob/master/sns/2.x.x/README.md#policy) | **Optional.** The security policy for the SNS Topic.\n`tags` | object | **Optional.** Key-value pairs that represent AWS tags on the topic.\n`bindingVersion` | string | **Optional**, defaults to `latest`. The version of this binding.',
    targetSpecs: AsyncAPI2,
  },
  {
    docs: '#### [Channel Binding Object](https://github.com/asyncapi/bindings/blob/master/sns/3.0.0/README.md#channel)\n\nThis object contains the information to configure the associated SNS Topic.\n\nField Name | Type | Description\n---|:---:|---\n`name` | string | **Required.** The name of the topic. Can be different from the channel name to allow flexibility around AWS resource naming limitations.\n`ordering` | [ordering](https://github.com/asyncapi/bindings/blob/master/sns/3.0.0/README.md#ordering) | **Optional.** By default, we assume an unordered SNS topic. This field allows configuration of a FIFO SNS Topic.\n`policy` | [policy](https://github.com/asyncapi/bindings/blob/master/sns/3.0.0/README.md#policy) | **Optional.** The security policy for the SNS Topic.\n`tags` | object | **Optional.** Key-value pairs that represent AWS tags on the topic.\n`bindingVersion` | string | **Optional**, defaults to `latest`. The version of this binding.',
    targetSpecs: AsyncAPI3,
  },
];
