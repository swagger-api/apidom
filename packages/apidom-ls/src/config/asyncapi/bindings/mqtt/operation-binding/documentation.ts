const documentation = [
  {
    target: 'qos',
    docs: 'Defines the Quality of Service (QoS) levels for the message flow between client and server. Its value MUST be either 0 (At most once delivery), 1 (At least once delivery), or 2 (Exactly once delivery).',
  },
  {
    target: 'retain',
    docs: 'Whether the broker should retain the message or not.',
  },
  {
