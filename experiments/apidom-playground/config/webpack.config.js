  ...
  return {
    ...
    resolve: {
      ...
      alias: {
        ...
        'apidom-ns-asyncapi-2': path.resolve(paths.apidomPath, 'apidom-ns-asyncapi-2'),
        ...
        'apidom-parser-adapter-asyncapi-json-2': path.resolve(
          paths.apidomPath,
          'apidom-parser-adapter-asyncapi-json-2'
        ),
        'apidom-parser-adapter-asyncapi-yaml-2': path.resolve(
          paths.apidomPath,
