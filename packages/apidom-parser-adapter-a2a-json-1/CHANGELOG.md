...
**Note:** Version bump only for package @swagger-api/apidom-parser-adapter-a2a-json-1
...
- **a2a:** initial parser adapter for A2A v1 AgentCard documents in JSON format. Uses structural detection (`capabilities` + `skills` co-presence) since A2A has no version discriminator field.
