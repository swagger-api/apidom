import { Element, ObjectElement, isObjectElement, isStringElement } from 'apidom';
import {MetadataMap, Metadata, LinterFunctions} from "../../../apidom/packages/apidom-ls";

/* METADATA */

const metadataMapOpenapi: MetadataMap = {
      "openApi3_1": {
        "yaml": {
          "completion": [
            {
      ...
      "*": {
        "lint": [
          ...
          },
          {
            "code": 1,
            "source": "LINTER",
            "message": "strings must be pascal case",
            "severity": 1,
            "linterFunction": "pascalCaseLinter",
            "marker": "value"
          }
        ]
      },
