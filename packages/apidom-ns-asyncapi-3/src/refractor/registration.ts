 ...
 * AsyncApi 3.0.0 specification elements.
 */
AsyncApi3Element.refract = createRefractor([
  'visitors',
  'document',
  'objects',
  'AsyncApi',
...
ChannelElement.refract = createRefractor([
  'visitors',
  'document',
  'objects',
  'Channel',
...
MessagesElement.refract = createRefractor([
  'visitors',
  'document',
  'objects',
  'Messages',
...
MultiFormatSchemaElement.refract = createRefractor([
  'visitors',
  'document',
  'objects',
  'MultiFormatSchema',
...
OperationReplyElement.refract = createRefractor([
  'visitors',
  'document',
  'objects',
  'OperationReply',
...
OperationReplyAddressElement.refract = createRefractor([
  'visitors',
  'document',
  'objects',
...
OperationsElement.refract = createRefractor([
  'visitors',
  'document',
  'objects',
  'Operations',
