...
import { RenderGraphWithIndex } from '../../../utils/handlebars/types';

function complete(
  textDocument: TextDocument,
  templateContext: RenderGraphWithIndex,
  position: Position,
  ...
  const rawSuggestions = findTypeSchemaPropertyKeys(templateContext, pointer);
