const documentation = [
  {
    ...
    docs: '**REQUIRED.** The authorization URL to be used for this flow. This MUST be in the form of a URL.',
  },
  {
    target: 'tokenUrl',
    docs: '**REQUIRED.** The token URL to be used for this flow. This MUST be in the form of a URL.',
  },
  {
    target: 'refreshUrl',
    docs: 'The URL to be used for obtaining refresh tokens. This MUST be in the form of a URL.',
  },
  {
    target: 'scopes',
