...
const documentation = [
  ...
  {
    target: 'format',
    docs: 'The extending format for the previously mentioned [`type`](https://github.com/OAI/OpenAPI-Specification/blob/main/versions/2.0.md#parameterType). See [Data Type Formats](#dataTypeFormat) for further details.',
    targetSpecs: OpenAPI2,
  },
  {
    target: 'items',
