...
[Detection](https://github.com/swagger-api/apidom/blob/main/packages/apidom-parser-adapter-openapi-json-3-1/src/adapter.ts#L17) is based on a regular expression matching required OpenAPI 3.1.0 specification symbols in JSON format.
