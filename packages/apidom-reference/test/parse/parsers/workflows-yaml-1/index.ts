...
import WorkflowsYAML1Parser from '../../../../src/parse/parsers/workflows-yaml-1/index.ts';
...
describe('parsers', function () {
  context('new WorkflowsYAML1Parser', function () {
    ...
    context('parse', function () {
      context('given Workflows 1.0.0 YAML data', function () {
      ...
      context('given Workflows 1.0.0 YAML data as buffer', function () {
        specify('should return parse result', async function () {
          const uri = path.join(__dirname, 'fixtures', 'sample-workflow.yaml');
