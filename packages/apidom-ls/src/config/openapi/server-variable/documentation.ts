...
const documentation = [
  ...
  {
    target: 'default',
    docs: "**REQUIRED.** The default value to use for substitution, which SHALL be sent if an alternate value is *not* supplied. Note this behavior is different than the [Schema Object's](https://spec.openapis.org/oas/v3.2.0.html#schema-object) treatment of default values, because in those cases parameter values are optional. If the [`enum`](https://spec.openapis.org/oas/v3.2.0.html#server-variable-enum) is defined, the value MUST exist in the enum's values.",
    targetSpecs: OpenAPI32,
  },
  {
    target: 'description',
