enum ApilintCodes {
  ...
  A2A1_OAUTH_FLOWS_FIELD_IMPLICIT_TYPE = 9080400,
  A2A1_OAUTH_FLOWS_FIELD_PASSWORD_TYPE = 9080500,
  ...
  A2A1_IMPLICIT_OAUTH_FLOW = 9120000,
  A2A1_IMPLICIT_OAUTH_FLOW_FIELD_AUTHORIZATION_URL_TYPE = 9120100,
  A2A1_IMPLICIT_OAUTH_FLOW_FIELD_REFRESH_URL_TYPE = 9120200,
  A2A1_IMPLICIT_OAUTH_FLOW_FIELD_SCOPES_TYPE = 9120300,
  A2A1_IMPLICIT_OAUTH_FLOW_FIELD_AUTHORIZATION_URL_REQUIRED = 9120400,

  A2A1_PASSWORD_OAUTH_FLOW = 9130000,
  A2A1_PASSWORD_OAUTH_FLOW_FIELD_TOKEN_URL_TYPE = 9130100,
  A2A1_PASSWORD_OAUTH_FLOW_FIELD_REFRESH_URL_TYPE = 9130200,
  A2A1_PASSWORD_OAUTH_FLOW_FIELD_SCOPES_TYPE = 9130300,
  A2A1_PASSWORD_OAUTH_FLOW_FIELD_TOKEN_URL_REQUIRED = 9130400,
}
