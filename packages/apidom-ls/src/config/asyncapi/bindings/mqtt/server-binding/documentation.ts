const documentation = [
  ...
  {
    target: 'cleanSession',
    docs: 'Whether to create a persistent connection or not. When `false`, the connection will be persistent.',
  },
  {
    target: 'lastWill',
    docs: 'Last Will and Testament configuration.',
  },
  {
    target: 'keepAlive',
    docs: 'Interval in seconds of the longest period of time the broker and the client can endure without sending a message.',
  },
  {
