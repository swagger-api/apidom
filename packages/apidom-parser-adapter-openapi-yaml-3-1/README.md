...
`@swagger-api/apidom-parser-adapter-openapi-yaml-3-1` is currently hosted on [GitHub packages registry](https://docs.github.com/en/packages/learn-github-packages/introduction-to-github-packages).
For installing `@swagger-api/apidom-parser-adapter-openapi-yaml-3-1` from GitHub packages registry, create `.npmrc` file in your current directory and add
