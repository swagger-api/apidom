...
[Detection](https://github.com/swagger-api/apidom/blob/main/packages/apidom-parser-adapter-openapi-yaml-2/src/adapter.ts#L21) is based on a regular expression matching required OpenAPI 2.0 specification symbols in YAML format.
