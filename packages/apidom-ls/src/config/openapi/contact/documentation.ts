const documentation = [
  ...
  {
    target: 'url',
    docs: 'The URL pointing to the contact information. MUST be in the form of a URL.',
    targetSpecs: [
      { namespace: 'openapi', version: '3.0.0' },
      { namespace: 'openapi', version: '3.0.1' },
      { namespace: 'openapi', version: '3.0.2' },
  ...
  {
    target: 'email',
    docs: 'The email address of the contact person/organization. MUST be in the form of an email address.',
    targetSpecs: [
      { namespace: 'openapi', version: '3.0.0' },
      { namespace: 'openapi', version: '3.0.1' },
      { namespace: 'openapi', version: '3.0.2' },
