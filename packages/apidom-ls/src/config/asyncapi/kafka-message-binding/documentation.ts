const documentation = [
  {
    target: 'key',
    docs: '[Schema Object](https://www.asyncapi.com/docs/specifications/v2.4.0#schemaObject) \\| [AVRO Schema Object](https://avro.apache.org/docs/current/spec.html)\n\\\n\\\n The message key. **NOTE**: You can also use the [reference object](https://asyncapi.io/docs/specifications/v2.4.0#referenceObject) way.',
  },
  {
