...
`apidom-parser-adapter-openapi-json-3-1` is a parser adapter for the [OpenApi 3.1.0 specification](https://github.com/OAI/OpenAPI-Specification/blob/master/versions/3.1.0.md) in [JSON format](https://www.json.org/json-en.html).
...
[Detection](https://github.com/swagger-api/apidom/blob/master/apidom/packages/apidom-parser-adapter-openapi-json-3-1/src/adapter.ts#L13) is based on a regular expression matching required OpenApi 3.1.0 specification symbols in JSON format.
...
```js
import { parse, detect } from 'apidom-parser-adapter-openapi-json-3-1';
...
import * as openApiJsonAdapter from 'apidom-parser-adapter-openapi-json-3-1';
