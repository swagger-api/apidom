  ...
  context('AsyncApiYaml2Parser', function () {
    context('canParse', function () {
      ...
      context('given file with supported extension', function () {
        context('and file data is buffer and can be detected as AsyncAPI 2.4.0', function () {
          specify('should return true', async function () {
        ...
        context('and file data is string and can be detected as AsyncAPI 2.4.0', function () {
          specify('should return true', async function () {
            const url = path.join(__dirname, 'fixtures', 'sample-api.yaml');
            const file = File({
              uri: '/path/to/async-api.yaml',
    ...
    context('parse', function () {
      context('given AsyncApi 2.4.0 YAML data', function () {
      ...
      context('given AsyncApi 2.4.0 YAML data as buffer', function () {
        specify('should return parse result', async function () {
          const url = path.join(__dirname, 'fixtures', 'sample-api.yaml');
