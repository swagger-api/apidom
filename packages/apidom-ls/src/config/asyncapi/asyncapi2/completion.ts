...
const completion: ApidomCompletionItem[] = [
  ...
  },
  {
    ...
    documentation: {
      kind: 'markdown',
      value:
        '[Info Object](https://www.asyncapi.com/docs/specifications/v2.3.0#infoObject)\n\\\n\\\n**Required.** Provides metadata about the API. The metadata can be used by the clients if needed.',
    },
  },
  {
    label: 'servers',
