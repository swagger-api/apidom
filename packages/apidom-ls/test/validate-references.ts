...
describe('reference validation', function () {
  ...
  context('given doc with references', function () {
    ...
    specify(
      'should validate with apidom-reference including external refs with continue on error',
      async function () {
        this.timeout(10000);
        const validationContext: ValidationContext = {
          comments: DiagnosticSeverity.Error,
    ...
    specify(
      'should validate valid spec with apidom-reference including external refs with continue on error',
      async function () {
        this.timeout(10000);
    ...
    specify(
      'should validate with apidom-reference excluding external refs with continue on error',
      async function () {
        this.timeout(10000);
        const validationContext: ValidationContext = {
          comments: DiagnosticSeverity.Error,
    ...
    specify(
      'should validate valid async spec with apidom-reference with continue on error',
      async function () {
        this.timeout(10000);
        const validationContext: ValidationContext = {
          comments: DiagnosticSeverity.Error,
