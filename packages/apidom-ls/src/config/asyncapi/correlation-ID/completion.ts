...
const completion: ApidomCompletionItem[] = [
  ...
  },
  {
    ...
    documentation: {
      kind: 'markdown',
      value:
        '**REQUIRED.** A [runtime expression](https://www.asyncapi.com/docs/reference/specification/v2.4.0#runtimeExpression) that specifies the location of the correlation ID.',
    },
  },
  {
    label: '$ref',
