  ...
  context('isOpenApi3_2Element', function () {
    context('given OpenApi3_2Element instance value', function () {
      specify('should return true', function () {
        ...
        assert.isTrue(isOpenApi3_2Element(element));
      });
    });
    ...
    context('given subtype instance value', function () {
      specify('should return true', function () {
        ...
        class OpenApi3_2SubElement extends OpenApi3_2Element {}

        assert.isTrue(isOpenApi3_2Element(new OpenApi3_2SubElement()));
      });
    });

    context('given non OpenApi3_2SubElement instance value', function () {
      specify('should return false', function () {
        assert.isFalse(isOpenApi3_2Element(1));
        assert.isFalse(isOpenApi3_2Element(null));
        assert.isFalse(isOpenApi3_2Element(undefined));
        assert.isFalse(isOpenApi3_2Element({}));
        assert.isFalse(isOpenApi3_2Element([]));
        assert.isFalse(isOpenApi3_2Element('string'));
      });
    });
