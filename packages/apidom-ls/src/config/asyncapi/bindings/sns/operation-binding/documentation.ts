...
const documentation = [
  ...
  {
    docs: '#### [Operation Binding Object](https://github.com/asyncapi/bindings/blob/master/sns/2.x.x/README.md#operation)\n\nThis object contains the information to configure the SNS Topic for a publish (send to subscribers) operation.\n\nField Name | Type | Applies To | Description\n---|:---:|:---:|---\n`topic` | [identifier](https://github.com/asyncapi/bindings/blob/master/sns/2.x.x/README.md#identifier) | Publish, Subscribe | **Optional.** The SNS topic identifier for the channel, in case the topic name is not the channel name in the AsyncAPI document.\n`consumers` | [[consumer](https://github.com/asyncapi/bindings/blob/master/sns/2.x.x/README.md#consumer)] | Publish | **Required.** The protocols that listen to this topic, for the publish (send to subscribers) operation.\n`deliveryPolicy` | [deliveryPolicy](https://github.com/asyncapi/bindings/blob/master/sns/2.x.x/README.md#delivery-policy) | Subscribe | **Optional.** Policy for retries to HTTP. The default for HTTP receivers of the SNS Topic.\n`bindingVersion` | string | Publish, Subscribe | **Optional**, defaults to `latest`. The version of this binding.',
    targetSpecs: AsyncAPI2,
  },
  {
    docs: '#### [Operation Binding Object](https://github.com/asyncapi/bindings/blob/master/sns/3.0.0/README.md#operation)\n\nThis object contains the information to configure the SNS Topic for a send or receive operation.\n\nField Name | Type | Applies To | Description\n---|:---:|:---:|---\n`topic` | [identifier](https://github.com/asyncapi/bindings/blob/master/sns/3.0.0/README.md#identifier) | send, receive | **Optional.** The SNS topic identifier for the channel, in case the topic name is not the channel name in the AsyncAPI document.\n`consumers` | [[consumer](https://github.com/asyncapi/bindings/blob/master/sns/3.0.0/README.md#consumer)] | receive | **Required.** The protocols that listen to this topic, for the receive operation.\n`deliveryPolicy` | [deliveryPolicy](https://github.com/asyncapi/bindings/blob/master/sns/3.0.0/README.md#delivery-policy) | send | **Optional.** Policy for retries to HTTP. The default for HTTP receivers of the SNS Topic.\n`bindingVersion` | string | send, receive | **Optional**, defaults to `latest`. The version of this binding.',
    targetSpecs: AsyncAPI3,
  },
];
