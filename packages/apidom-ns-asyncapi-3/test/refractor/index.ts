...
describe('refractor', function () {
  context('given generic ApiDOM object in AsyncApi 3.0.0 shape', function () {
    specify('should refract to AsyncApi3Element', function () {
      const asyncApiString = fs
        .readFileSync(path.join(__dirname, 'fixtures', 'asyncapi-3-0-0.json'))
        .toString();
  ...
  context('supports plugins', function () {
    ...
    context('plugin', function () {
      specify('should be called with toolbox object', function () {
        ...
        AsyncApi3Element.refract(genericObject, {
          plugins: [plugin1],
        });
    ...
    context('visitor', function () {
      ...
      context('first plugin', function () {
        ...
        specify('should augment asyncapi version', function () {
          ...
          const asyncApiElement = AsyncApi3Element.refract(genericObject, {
            plugins: [plugin1],
          });
