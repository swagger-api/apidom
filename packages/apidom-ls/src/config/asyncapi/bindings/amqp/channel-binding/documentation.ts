const documentation = [
  ...
  {
    target: 'exchange',
    docs: 'When `is=routingKey`, this object defines the exchange properties.',
  },
  {
    target: 'queue',
    docs: 'When `is=queue`, this object defines the queue properties.',
  },
  {
