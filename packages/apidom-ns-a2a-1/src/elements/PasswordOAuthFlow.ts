 ...
 * @public
 *
 * Deprecated by A2A spec; use Authorization Code + PKCE or Device Code.
 */
class PasswordOAuthFlow extends ObjectElement {
  constructor(content?: Record<string, unknown>, meta?: Meta, attributes?: Attributes) {
    super(content, meta, attributes);
    this.element = 'passwordOAuthFlow';
    this.classes.push('password-oauth-flow');
...
export default PasswordOAuthFlow;
