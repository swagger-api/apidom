...
const parameterComplete: ApidomCompletionItem[] = [
  {
    label: 'description',
  ...
  },
  {
    ...
    documentation: {
      kind: 'markdown',
      value:
        'A [runtime expression](https://www.asyncapi.com/docs/specifications/v2.2.0#runtimeExpression) that specifies the location of the parameter value. Even when a definition for the target field exists, it **MUST NOT** be used to validate this parameter but, instead, the `schema` property **MUST** be used.\n\n ---- \n\nThis object can be extended with [Specification Extensions](https://www.asyncapi.com/docs/specifications/v2.2.0#specificationExtensions).',
    },
  },
  {
    label: '$ref',
...
export default parameterComplete;
