...
var ChannelItem = /*#__PURE__*/function (_ObjectElement) {
  _inherits(ChannelItem, _ObjectElement);

  var _super = _createSuper(ChannelItem);

  function ChannelItem(content, meta, attributes) {
    var _this;

    _classCallCheck(this, ChannelItem);

    _this = _super.call(this, content, meta, attributes);
    _this.element = 'channelItem';
    return _this;
  }
